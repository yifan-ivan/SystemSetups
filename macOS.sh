...
BREW_CASK=("iina" "docker" "java" "microsoft-edge" "iterm2" "visual-studio-code" "sourcetree" "wechat" "qq" "obsidian" "discord" "scroll-reverser" "font-hack-nerd-font" "istat-menus" "google-chrome" "forklift" "intellij-idea-ce" "keka")
